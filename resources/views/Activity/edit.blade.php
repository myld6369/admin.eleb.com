...
@section('contents')
    ...
    <div class="container">
        ...
        <form action="{{route('activities.update',['activity'=>$activity])}}" method="post">
            ...
            <div class="form-group">
                <label>选择开始时间</label>
                <input type="datetime-local" name="start_time" class="form-control" value="{{date("Y-m-d\TH:i",$activity->start_time)}}">
            </div>
            <div class="form-group">
                <label>选择结束时间</label>
                <input type="datetime-local" name="end_time" class="form-control" value="{{date("Y-m-d\TH:i",$activity->end_time)}}">
            </div>
            <div class="form-group">
                <label>内容</label>
            </div>
