        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            @foreach($shops_categories as $shops_category)
                <tr class="tr">
                    ...
                    <td><img src="{{$shops_category->img}}" width="50"></td>
                    <td>{{$shops_category->status==1?'是':'否'}}</td>
                    <td><a href="{{route('shops_categories.edit',['shops_category'=>$shops_category])}}" class="btn btn-xs btn-primary">修改</a></td>
                    <td>
            ...
            @endforeach
            <tr>
                <td colspan="10"><a href="{{route('shops_categories.create')}}" class="btn btn-xs btn-primary">添加</a></td>
            </tr>
        </table>
    </div>
    @endsection