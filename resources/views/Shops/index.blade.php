        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            @foreach($shops as $shop)
                <tr class="tr">
                    ...
                    <td><a href="{{route('shops.show',['shop'=>$shop])}}" class="btn btn-xs btn-primary">审核</a></td>
                    <td><a href="{{route('shops.edit',['shop'=>$shop])}}" class="btn btn-xs btn-primary">修改</a></td>
                    <td>
            ...
            @endforeach
            <tr>
                <td colspan="19"><a href="{{route('shops.create')}}" class="btn btn-xs btn-primary">添加</a></td>
            </tr>
        </table>
    </div>
    @endsection